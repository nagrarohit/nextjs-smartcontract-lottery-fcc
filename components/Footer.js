export default function Footer() {
    return (
        <footer className="bg-blue-500 text-white p-4 text-center flex justify-between items-center">
            <div className="text-left">
                <p className="text-sm">© 2023 Decentralized Bet. All rights reserved.</p>
            </div>
            <div className="ml-auto">
                <a
                    href="https://github.com/nagrarohit/nextjs-smartcontract-lottery-fcc"
                    target="_blank"
                ...
                >
                    <svg
                        height="24"
                        className="octicon octicon-mark-github text-white transition-transform duration-300 transform scale-100 hover:scale-110"
                        viewBox="0 0 16 16"
                        version="1.1"
                        width="24"
                        aria-hidden="true"
